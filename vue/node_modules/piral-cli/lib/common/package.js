...
function getPiralPackage(app, data, version, bundler) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const devDependencies = Object.assign(Object.assign({}, (0, language_1.getDevDependencies)(data.language, (0, language_1.getDevDependencyPackages)(framework, data.reactVersion, data.reactRouterVersion))), { 'piral-cli': `${version}` });
        const dependencies = Object.assign(Object.assign({}, (0, language_1.getFrameworkDependencies)(framework, version)), (0, language_1.getDependencies)(data.language, (0, language_1.getDependencyPackages)(framework, data.reactVersion, data.reactRouterVersion)));
...
function findDependencyVersion(pckg, rootPath, packageName, parents = []) {
    var _a;

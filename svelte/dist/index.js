...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(h3, "class", "svelte-1wf1ehn");
      (0, _internal.add_location)(h3, file, 14, 2, 159);
      (0, _internal.set_custom_element_data)(svelte_extension, "name", "smiley");
      (0, _internal.add_location)(svelte_extension, file, 17, 4, 232);
      (0, _internal.add_location)(p, file, 15, 2, 186);
      (0, _internal.add_location)(button0, file, 19, 2, 293);
      (0, _internal.add_location)(button1, file, 20, 2, 352);
      (0, _internal.attr_dev)(div, "class", "tile");
      (0, _internal.add_location)(div, file, 13, 0, 138);
    },
...
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } /* Page.svelte generated by Svelte v3.58.0 */
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.add_location)(h1, file, 7, 0, 54);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },

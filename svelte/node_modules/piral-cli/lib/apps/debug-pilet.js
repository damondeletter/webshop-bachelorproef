...
function debugPilet(baseDir = process.cwd(), options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, common_1.watcherTask)((watcherContext) => __awaiter(this, void 0, void 0, function* () {
            var _c, _d, _e, _f;
            ...
            yield Promise.all(appInstances.sort(byPort).map(([appDir, appPort], i) => __awaiter(this, void 0, void 0, function* () {
                ...
                const port = yield (0, common_1.getAvailablePort)(suggestedPort);
                ...
                yield ((_j = hooks.beforeOnline) === null || _j === void 0 ? void 0 : _j.call(hooks, { krasServer, krasConfig, open, port, api, feed, pilets, publicUrl }));
                yield krasServer.start();
                (0, common_1.openBrowser)(open, port, publicUrl, !!krasConfig.ssl);
                yield ((_k = hooks.afterOnline) === null || _k === void 0 ? void 0 : _k.call(hooks, { krasServer, krasConfig, open, port, api, feed, pilets, publicUrl }));
